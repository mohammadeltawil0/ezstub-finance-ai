...
public class AnalyticsController {
    ...
    public Map<String, BigDecimal> getTotalSpending(@PathVariable Long userId, @PathVariable String month) {
        return analyticsService.getTotalSpending(userId, month);
    }

    // Get spending by category
    @GetMapping("/categories/user/{userId}/month/{month}")
    public Map<String, BigDecimal> getSpendingByCategory(@PathVariable Long userId, @PathVariable String month) {
